...
<div class="w3layouts-main">
	...
	<h2>Đăng nhập</h2>
	<?php 
	// kiểm tra thông báo login thất bại
		$errl = Session::get('errl');
		if($errl)
		{
			echo '<span class="alert-text">'.$errl.'</span>';
			Session::put('errl',null);
		}
	?>
    	...
    	<input type="hidden" name="_token" value="{{ csrf_token() }}" />
			...
			<h6><a href="#">Quên mật khẩu?</a></h6>
				...
				<input type="submit" value="Đăng nhập" name="admin_dangnhap">
		</form>
